...
/* The standard set-up */
    ...
    int numberOfBins = 4*2;


// ---------------------------------------------------------------------------------------------------------------------
/*  Run with no interaction for all omegas and suiting numbers for one-body density plots */
// ---------------------------------------------------------------------------------------------------------------------
    ...
    // std::vector<double> binNumbers = {100, 200, 300, 400, 700};

    // N = 6:
    // numberOfParticles = 6;
    // std::vector<double> binLengths = {6.0, 6.0, 12.0, 15.0, 21.0};
...
// ---------------------------------------------------------------------------------------------------------------------
/* Same but for the interacting case with the optimal parameters */   
// ---------------------------------------------------------------------------------------------------------------------
    ...
    // std::vector<double> binLengths = {6.0, 6.0, 15.0, 21.0, 27.0};
    // std::vector<double> binNumbers = {200, 200, 500, 700, 900};

    // N = 2:
    // numberOfParticles = 2;
    // std::vector<double> alphas = {0.98846, 0.98082, 0.94734, 0.92262, 0.88305};
    // std::vector<double> betas = {0.39954, 0.31068, 0.17810, 0.14090, 0.07366};
    // std::vector<double> binLengths = {6.0, 6.0, 12.0, 15.0, 18.0};
    // std::vector<double> binNumbers = {200, 300, 400, 500, 600};

    // for (int b= 2; b<binLengths.size(); b++){
...
// ---------------------------------------------------------------------------------------------------------------------
    ...
    // numberOfDimensions  = 2;
    // numberOfParticles   = 12;
    // numberOfSteps       = (int) std::pow(2,20.0);
    ...
    // for (int k=0;  energyChange > stopCriteria && k <= 500; k++){
