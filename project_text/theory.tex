...
We will use Variational Monte Carlo (VMC) methods to evaluate the Eq. \ref{eq:expectation_energy}. The exact wave function for two not interacting electrons in the ground state is given by
...
2\left< T\right> = -\left< V_{ext}\right>
\end{equation}