...
\begin{table}[H]\caption{Not parallelized: $2^{24}$ MC cycles, one thread. Parallelized: $2^{22}$ MC cycles, four threads. An average over five runs.}\label{tab:CPUtime_parallelization}
\center
\begin{tabular}{r|ccc}
