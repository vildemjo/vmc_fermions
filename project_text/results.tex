...
\begin{figure}[H]
\center
\includegraphics[width=0.85\linewidth]{../Results/one_body_density_no_interaction_2p_smoothed}\caption{•}\label{fig:one_body_density_no_interaction_2p_smoothed}
\end{figure}
